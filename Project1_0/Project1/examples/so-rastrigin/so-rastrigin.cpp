...
//		std::ostringstream out;
//		out << "{";
//		for (unsigned long i = 0; i < relativePosition.size(); i++)
//			out << (i ? "," : "") << std::setprecision(10) << relativePosition[i];
//		out << "}";
//		return out.str();
//	}
//};
...
//int main()
//{
//	output_file.open("./aresult_so-rastrigin.txt");
//	output_file
//		<<"step"<<"\t"
//		<<"cost_avg"<<"\t"
//		<<"cost_best"<<"\t"
